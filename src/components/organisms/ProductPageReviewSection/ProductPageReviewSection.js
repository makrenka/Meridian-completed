...
export class ProductPageReviewSection extends Component {
    ...
    componentDidMount() {
        ...
        this.addEventListener('send-comments-length', this.saveCount);
    }
    ...
    componentWillUnmount() {
        ...
        this.removeEventListener('send-comments-length', this.saveCount);
    }
            ...
            <section class="product-main__reviews">
                <div class="container">
                    <div class="product-main__reviews-heading-wrapper">
                        <h3 class="product-main__reviews-heading">Reviews (${this.state.comments.filter(item => item.product == this.props.title).length})</h3>
